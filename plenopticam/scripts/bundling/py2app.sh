...
# generate MacOSX app
sudo python3 setup.py py2app --packages=tkinter || sudo python setup.py py2app --packages=tkinter
...
sudo mkdir -p dist/plenopticam.app/Contents/Resources/lib/python3.6/lib-dynload/.dylibs/
sudo mv dist/plenopticam.app/Contents/Frameworks/libopenjp2.2.1.0.dylib dist/plenopticam.app/Contents/Resources/lib/python3.6/lib-dynload/.dylibs/libopenjp2.2.1.0.dylib

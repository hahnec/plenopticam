...
class CfaHotPixels(object):
    ...
    def rectify_candidates_bayer(self, bay_img, n=2, sig_lev=4):
        ...
        if self.cfg.params[self.cfg.opt_dbug]:
            ...
            misc.save_img_file(cum_img, file_path=os.path.join(self.cfg.exp_path, 'hotpixel_map_'+str(hotp_num)+'.png'))
    ...
    def rectify_candidates_channel(self, channel, ref_img=None, med_img=None, n=2, sig_lev=4):
        ...
        # pre-select outlier candidates (narrow-down search area and speed-up the process)
